...
All linear jerk variables (include 'AccJerk' in name) are in units of standard earth gravity 'g' divided by seconds [g/s].
All angular velocity variables (include 'Gyro', but not 'Jerk' in name) are in units of radians/second. 
All angular jerk variables (include 'GyroJerk') are in units of angular acceleration [radians/second^2].
...
Multiple sets of data were collected for each combination of subject/activity. The set of variables that were estimated from these signals are: 
